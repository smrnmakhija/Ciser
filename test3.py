...
def drawing():
	...
	beta_1=[]
	rep_1=[]
	for k1 in np.arange(0.0339, 0.4761,0.1):
		for k2 in np.arange(0.0715,0.1430,0.1):
			for k3 in np.arange(6.0274e-4,9.8173e-4,0.1):
				for p in np.arange(0,1,0.1):
					for sigma in np.arange(0.0357,0.476,0.1):
						#p=epsolon*rho*gamma
